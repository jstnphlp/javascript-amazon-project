...
function updateCheckoutItem(cart) {
    document.querySelector('.js-item-quantity').innerHTML = `${updateCartQuantity(cart)} items`;
}
...
document.querySelectorAll('.js-save-link').forEach((link) => {
    link.addEventListener('click', () => {
        ...
        container.querySelector('.quantity-label').innerHTML = updateQuantity(productId, newQuantity);

        updateCheckoutItem(cart);
        updateCheckoutPrice(cart);
    });
});
